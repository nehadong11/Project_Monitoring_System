...
<title>Project Monitoring System - Registration Form</title>
...
<body>
	...
	<div class="container">
		<form action='<spring:url value="/signup"/>' method="post"
			...
			<h2 class="text-center">Sign Up Your Self For Project
				Collaboration</h2>
			<div class="row jumbotron">
			<div class="col-sm-6 form-group">
					<label for="name-f">PRN</label> <input type="text"
						class="form-control" name="prn" id="prn"
				...
				<div class="col-sm-6 form-group">
					<label for="name-f">Course Name</label> <select type="text"
						...
						<option value="DGI">PG-DGi</option>
				...
				<div class="col-sm-6 form-group">
					<label for="name-f">Course Batch Year</label> <input type="text"
						class="form-control" name="courseBatchYear" id="courseBatchYear"
				...
				<div class="col-sm-6 form-group">
					<label for="name-f">Course Duration</label> <input type="text"
						class="form-control" name="courseDuration" id="courseDuration"
				...
				<div class="col-sm-4 form-group">
					<label for="tel">Mobile</label> <input type="tel" name="mobile"
				...
				<div class="col-sm-12">
					<input type="checkbox" name="MyCheckbox"
						...
						for="chb" class="form-check-label">&nbsp;I accept all
